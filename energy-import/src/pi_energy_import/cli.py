...
def panel(panel_id: int, title: str, csv_content: str, y: int, unit: str) -> dict:
    return {
...
def dashboard(rows: dict[str, list[dict[str, str]]], destination: Path) -> None:
    ...
    body = {
        ...
        "panels": [
            ...
            panel(3, "Monthly electricity usage", monthly_electric, 15, "kWh"),
            panel(4, "Monthly gas usage", monthly_gas, 25, "m3"),
        ],
